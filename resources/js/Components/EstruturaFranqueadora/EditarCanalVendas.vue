      ...
      <div class="flex justify-center items-center mb-8">
        ...
        <div class="flex flex-col items-center">
          <div class="relative group">
            <div
              class="w-[110px] h-[110px] bg-[#f3f8f3] rounded-xl flex items-center justify-center cursor-pointer overflow-hidden p-2"
...
// Dados do formulário
const canal_id = ref(props.canal.id);
const nome = ref(props.canal.nome);
const profilePhotoUrl = ref(props.canal.img_icon || '');
...
// canal para gerar a URL correta da imagem
...
const submitForm = async () => {
  ...
  if (Object.keys(errors.value).length === 0) {
    try {
      ...
      formData.append('id', canal_id.value);
      ...
      // Enviar os dados para o backend (atualizando o canal de vendas)
      const response = await axios.post(
        '/api/admin-canais-vendas/atualizar', // Ajuste a URL para corresponder ao ID do canal
        formData,
        {
          headers: {
      ...
      toast.success('canal de vendas atualizado com sucesso!');
      // Limpar o formulário
      cancelForm();
    } catch (error) {
      toast.error('Erro ao atualizar canal de vendas');
      console.error('Erro ao atualizar canal de vendas:', error);
    } finally {
