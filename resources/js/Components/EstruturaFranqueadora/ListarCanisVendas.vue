<template>
  <div>
    ...
    <!-- Título principal -->
    <div class="painel-title">Canais de vendas</div>

    <!-- Subtítulo da página -->
    <div class="painel-subtitle">
      <p>Gerencie seus canais de vendas para o fluxo de caixa</p>
    </div>
...
const fetchDados = async () => {
  ...
  try {
    const response = await axios.get('/api/admin-canais-vendas/lista');
