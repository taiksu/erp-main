<template>
  ...
  <div class="mt-5">
    ...
    <div class="bg-white rounded-lg p-12">
      ...
      <LabelModel text="Nome do Canal de vendas" />
      <input
        id="nome"
        v-model="nome"
        ...
        placeholder="Nome do canal de vendas"
      />
      ...
      <div class="form-buttons">
        ...
        <ButtonPrimaryMedio
          ...
          @click="showConfirmDialog('Cadastar método de pagamento?')"
        />
      </div>
    </div>
  </div>
  ...
  if (Object.keys(errors.value).length === 0) {
    try {
      ...
      const response = await axios.post(
        '/api/admin-canais-vendas/cadastrar', // Ajuste a URL para corresponder ao ID do método
        formData,
        {
          headers: {
